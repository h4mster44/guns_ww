...
if (IsPedMale(pp) == 1) {
    AttachEntityToEntity(object, pp, 350, +0.04, 0.26, -0.04, +96.20, +80.10, +0.0, false, false, true, true, 0, true, false, false);
}
  if (IsPedMale(pp) == false) {
    AttachEntityToEntity(object, pp, 408, +0.04, 0.26, -0.04, +96.20, +80.10, +0.0, false, false, true, true, 0, true, false, false);
}
