...
if (IsPedMale(pp)) == 1) {
  AttachEntityToEntity(object, pp, 350, +0.18, +0.01, -0.02, -92.01, 0.0, +0.0, false, false, true, true, 0, true, false, false)
}
  if (IsPedMale(pp)) == false) {
  AttachEntityToEntity(object, pp, 408, +0.18, +0.01, -0.02, -92.01, 0.0, +0.0, false, false, true, true, 0, true, false, false)
}
